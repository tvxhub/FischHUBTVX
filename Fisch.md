...
local Window = Fluent:CreateWindow({
    Title = game:GetService("MarketplaceService"):GetProductInfo(16732694052).Name .." | TVXHUB",
    SubTitle = " (discord.gg/Dxc2DJfJeR)", -- discord link
    TabWidth = 160,
...
do
    Tabs.Home:AddButton({
        ...
        Callback = function()
            setclipboard("https://discord.gg/Dxc2DJfJeR") -- discord link
        end
    })
